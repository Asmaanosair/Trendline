        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title text-green"> Stocks Table</h3>
                    ...
                    <div class="modal modal-warning fade" id="modal-warning">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form role="form" action="{{url('/kt_admin/add_stock')}}" method="post" enctype="multipart/form-data" >
            ...
            <div class="containers">
                <table class="table table-striped projects text-center">
                    ...
                    @foreach($test as $row)
                        <form method="post" action="{{url('/kt_admin/up_stock/'.$row->id)}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input type="text" name="old" required="required" class="form-control" value="<?php echo $row->old_price; ?>">
                                    @if ($errors->has('old'))
                                        <span class="help-block">
                                            <strong>{{ $errors->first('old') }}</strong>
                                         </span>
                                ...
                                <td>
                                    <a href="{{url('/kt_admin/del_stock/'.$row->id)}}" class="btn btn-danger"> Delete</a>
                                </td>
