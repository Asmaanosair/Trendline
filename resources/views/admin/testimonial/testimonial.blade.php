        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title text-green"> Testimonials Table</h3>
                    ...
                    <div class="modal modal-warning fade" id="modal-warning">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form role="form" action="{{url('/kt_admin/add_test')}}" method="post" enctype="multipart/form-data" >
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  name="job" id="exampleInputPassword1"  placeholder="Title">
                                            @if ($errors->has('job'))
                                                <span class="help-block">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1" dir="rtl"> الوظيفه   </label>
                                            <textarea type="text" class="form-control" name="job_ar" id="exampleInputPassword1"  placeholder="العنوان"></textarea>
            ...
            <div class="containers">
                <table class="table table-striped projects text-center">
                    ...
                    <tbody>
                    @foreach($test as $row)
                        <form method="post" action="{{url('/kt_admin/up_test/'.$row->id)}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="job_ar" required="required" class="form-control" value="<?php echo $row->job_ar; ?>">
                                    @if ($errors->has('job_ar'))
                                        <span class="help-block">
                                            <strong>{{ $errors->first('job_ar') }}</strong>
                                         </span>
                                ...
                                <td>
                                    <a href="{{url('/kt_admin/del_test/'.$row->id)}}" class="btn btn-danger"> Delete</a>
                                </td>
